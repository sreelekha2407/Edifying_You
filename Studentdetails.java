...
public class Studentdetails extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.activity_studentdetails, container, false);
		return rootView;
	}
	@Override
	public void onViewCreated(View view,  Bundle savedInstanceState) 
	{
		...
		if(res.getCount()!=0)
		{
			...
			{
	            list.add("user :   "+res.getString(0)+"\npass:   "+res.getString(1)+"\n"+"nam:   "+res.getString(2)+"\n"+"mobile:   "+res.getString(3)+"\n"+"emid:   "+res.getString(4)+"faname:   "+res.getString(5)+"famo:   "+res.getString(6)+"moname:   "+res.getString(7)+"momo:   "+res.getString(8)+"ssc:   "+res.getString(9)+"\n"+"inter:"+res.getString(10)+"\n"+"eamcet"+res.getString(11));
		...
		t1.addTextChangedListener(new TextWatcher(){
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				// TODO Auto-generated method stub
				 Studentdetails.this.adapter.getFilter().filter(s); 
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
		        ...
		        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
		            ...
		            // Write your code here to invoke YES event
		        		...
		        		if(c.moveToFirst())
		        		{
		        			db.execSQL("DELETE FROM student WHERE user='"+c.getString(0)+"'");
